...
Scripts corresponding to an artificial selection experiment to evolve increased variability in left-right turn bias in fruit flies. The scripts are (or will be) organized in subfolders as such:
